...
function pressedsqueezed_scripts() {
	...
	wp_enqueue_script( 'josefin', 'http://use.edgefonts.net/josefin-slab.js', false, false, true );
	wp_enqueue_script( 'merriweather', 'http://use.edgefonts.net/merriweather.js', false, false, true );
